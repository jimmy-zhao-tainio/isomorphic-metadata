...
setlocal
set "ROOT=%~dp0..\..\.."
set "WORKSPACE=Samples\Demos\SuggestDemo\Workspace"
...
"%ROOT%\meta.exe" import csv Samples\Demos\SuggestDemo\demo-csv\products.csv --entity Product --new-workspace "%WORKSPACE%" || goto :fail

pushd "%WORKSPACE%" || goto :fail
"%ROOT%\meta.exe" import csv ..\demo-csv\suppliers.csv --entity Supplier || goto :fail
"%ROOT%\meta.exe" import csv ..\demo-csv\categories.csv --entity Category --plural Categories || goto :fail
...
echo.
echo == Suggest pass (eligible Id-based relationship promotions) ==
...
if exist "%CD%\workspace.xml" popd
popd
exit /b %EC%
