...
internal sealed partial class CliRuntime
{
    ...
    private const string InstanceDiffEqualModelTemplateResourceName = "Meta.Cli.Templates.InstanceDiffModel.Equal.xml";
    private const string InstanceDiffAlignedModelName = "InstanceDiffModelAligned";
    private const string InstanceDiffAlignedModelTemplateResourceName = "Meta.Cli.Templates.InstanceDiffModel.Aligned.xml";
    private const string InstanceDiffAlignmentModelName = "InstanceDiffModelAlignment";
    private const string InstanceDiffAlignmentModelTemplateResourceName = "Meta.Cli.Templates.InstanceDiffModel.Alignment.xml";
