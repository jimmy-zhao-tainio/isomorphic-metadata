...
$brokenWorkspaceJson = "{`n  `"contractVersion`": `"1.0`",`n  `"modelName`": `"BrokenModel`"`n}"
Set-Content -Path (Join-Path $brokenMetadataRoot "workspace.json") -Value $brokenWorkspaceJson -Encoding utf8
...
Add-Case -Name "view row" -SuccessArgs @("view", "row", "Cube", "1", "--workspace", $baseWorkspace) -FailureArgs @("view", "row", "Cube", "999", "--workspace", $baseWorkspace)
...
Add-Case -Name "row update" -SuccessArgs @("row", "update", "Cube", "10", "--set", "RefreshMode=Manual", "--workspace", $baseWorkspace) -FailureArgs @("row", "update", "Cube", "1", "--set", "MissingField=BadValue", "--workspace", $baseWorkspace)
Add-Case -Name "row relationship set" -SuccessArgs @("row", "relationship", "set", "Measure", "1", "--to", "Cube", "2", "--workspace", $baseWorkspace) -FailureArgs @("row", "relationship", "set", "Measure", "1", "--to", "Cube", "999", "--workspace", $baseWorkspace)
Add-Case -Name "row relationship list" -SuccessArgs @("row", "relationship", "list", "Measure", "1", "--workspace", $baseWorkspace) -FailureArgs @("row", "relationship", "list", "Measure", "999", "--workspace", $baseWorkspace)
...
Add-Case -Name "row relationship clear" -SuccessArgs @("row", "relationship", "clear", "Measure", "1", "--to-entity", "Cube", "--workspace", $baseWorkspace) -FailureArgs @("row", "relationship", "clear", "Cube", "1", "--to-entity", "System", "--workspace", $baseWorkspace)

Invoke-MetaStrict -MetaArgs @("row", "relationship", "set", "Measure", "1", "--to", "Cube", "2", "--workspace", $baseWorkspace) | Out-Null
