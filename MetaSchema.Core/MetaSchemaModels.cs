...
public static class MetaSchemaModels
{
    ...
    public static ModelDefinition CreateTypeConversionCatalogModel()
    {
        ...
        typeMapping.Relationships.Add(new RelationshipDefinition { Entity = "TypeSystem", Role = "SourceTypeSystem" });
        typeMapping.Relationships.Add(new RelationshipDefinition { Entity = "TypeSystem", Role = "TargetTypeSystem" });
        typeMapping.Relationships.Add(new RelationshipDefinition { Entity = "DataType", Role = "SourceDataType" });
        typeMapping.Relationships.Add(new RelationshipDefinition { Entity = "DataType", Role = "TargetDataType" });
